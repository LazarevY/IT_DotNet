...
{
    public class PortableVideoPlayer : Player
    {
        public PortableVideoPlayer(string serialNumber, (int, int) dimension) : base(serialNumber)
        {
            Dimension = dimension;
            CurrentMediaName = "Video " + new Random().Next();
        }

        public PortableVideoPlayer() : this("DEFAULT", (200, 200))
        {
